        ...
        <div className="relative z-10 w-full" style={{ paddingBottom: isMobile ? 0 : 96 }}>
          <div className={`max-w-[1240px] mx-auto px-4 sm:px-8 ${isMobile ? "max-w-[95vw]" : "max-w-[900px]"}`}>
            ...
            <div className="flex gap-6 sm:gap-12 border-t border-white/20 pt-5 sm:pt-7 flex-wrap reveal in" style={{ transitionDelay: '0.4s' }}>
              <div><span className="font-display text-white text-2xl sm:text-3xl font-semibold block"><em className="not-italic text-[#E9CE7E]" data-count="5000">0</em>+</span><span className="text-xs uppercase tracking-wider text-white/60">Happy Travelers</span></div>
          ...
          <div className="grid justify-start grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-white/10">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <a href={`mailto:${COMPANY_INFO.email}`} className="font-mono hover:text-[#E9CE7E] transition-colors">{COMPANY_INFO.email}</a>
                </li>
                <li>
                  <a href={`mailto:${COMPANY_INFO.additionalEmail}`} className="font-mono hover:text-[#E9CE7E] transition-colors">{COMPANY_INFO.additionalEmail}</a>
                </li>
